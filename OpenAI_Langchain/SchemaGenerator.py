...
class SchemaGenerator:
    ...
    def infer_data_type(self, values):
    ...
    def generate_schema(self, csv_filename, schema_filename):
        with open(csv_filename, 'r', encoding='utf-8-sig') as csvfile:
            ...
            for header in headers:
                ...
                weaviate_data_type = self.type_mapping.get(data_type, 'DataType.TEXT')
                properties.append({
                    'name': header,
...
if __name__ == "__main__":
    ...
    generator.generate_schema(csv_filename, schema_filename)
